...
function App() {
    return (
        <div>
            <header id="project-div" class="header">
                <div class="nav-bar">
                    ...
                    <ul class="listing">
                        <li>
                            <a href="#feature-div">FEATURES</a>
                        </li>
                        <li>
                            <a href="#offer-div">OFFER</a>
                        </li>
                        <li>
                            <a href="#pricing-div">PRICING</a>
                        </li>
                        <li>
                            <a href="#client-div">CLIENTS</a>
                        </li>
                        <li>
                            <a href="#fact-div">FACTS</a>
                        </li>
                        <li>
                            <a href="#project-div">PROJECTS</a>
                        </li>
                        <li>
                            <a href="#team-div">TEAMS</a>
                        </li>
                        <li>
                            <a href="#contact-div">CONTACTS</a>
                        </li>
                    </ul>
                </div>
